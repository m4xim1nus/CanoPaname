...
internal val SaisonPrintemps = Color(0xFFE8F5E9)
internal val SaisonEte = Color(0xFFDDEEDD)
internal val SaisonAutomne = Color(0xFFF5EBD9)
internal val SaisonHiver = Color(0xFFE6ECEF)
