...
class MapViewModel(
    ...
    fun savePending(p: PendingCapture) {
        ...
        state[K_PHOTO_PATH] = p.photoPath
    ...
    fun consumePending(): PendingCapture? {
        ...
        val pending = PendingCapture(
            ...
            photoPath = state.get<String>(K_PHOTO_PATH) ?: return null,
        ...
        state.remove<String>(K_PHOTO_PATH)
    ...
    companion object {
        ...
        private const val K_PHOTO_PATH = "pending.photoPath"
