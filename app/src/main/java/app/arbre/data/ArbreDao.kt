...
interface ArbreDao {
    ...
    @Query("SELECT COUNT(*) FROM arbre WHERE genre = :genre AND espece = :espece AND remarquable = 0")
    suspend fun compterArbresOrdinairesParEspece(genre: String, espece: String): Int
