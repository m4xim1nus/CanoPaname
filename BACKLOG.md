...
- [ ] tips : `dataset.rank_5` (« érable, 6 645 arbres ») fait doublon avec `dataset.iconic.acer_platanoides` (« l'érable plane a 6 645 représentants ») — même espèce, deux phrases. Mineur, à dédoublonner un jour côté `write_splash_tips`. (audit S6 Réveil, 2026-05-12)
